...
import { RESOLUTION_ARR } from '../../util/Settings'
import './index.css'
import aglogo from "../../assets/images/ag_logo.png";
import aglogin from "../../assets/images/ag-login.png";
...
class Index extends React.Component {
  ...
  handleJoin = () => {
    console.log("handle join", this.state)
    ...
    this.props.history.push({
     ...
     // search: `?event_id=${event_id}`,
      state: { 
        streaming_channel_name: "stream-44-1619446801" }
    })
  }
